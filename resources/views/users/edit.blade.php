...
<section id="add-user-form">
    <div class="mdl-card mdl-shadow--2dp wrapper">
        ...
        <div class="mdl-card__supporting-text">
            <form class="form-horizontal" role="form" autocomplete="off" method="POST" action="/user/update/{{$user->id}}">
                {!! csrf_field() !!}

                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label textfield-demo">
                    <input type="text" class="mdl-textfield__input" name="name" value="{{ $user->name }}" required>
                    <label class="mdl-textfield__label" for="sample3">Nom</label>
                </div>

                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label textfield-demo">
                    <input type="email" class="mdl-textfield__input" name="email" value="{{ $user->email }}" required>
